...
from flight_app.utils import generate_booking_reference, datetime, generate_default_password, generate_pilot_id, \
    generate_schedule_reference, timedelta, format_datetime
...
class Schedule(db.Model):
    ...
    # def add_pilot(self,firstname,lastname,email,gender,category,level): pilot = Pilot(firstname = firstname,
    # lastname = lastname, email = email,gender = gender,category = category,level=level,schedule_id = self.id)
    # db.session.add(pilot) db.session.commit()
...
class Pilot(db.Model):
    ...
    schedules = db.relationship('Schedule', secondary='scheduled_pilots',
